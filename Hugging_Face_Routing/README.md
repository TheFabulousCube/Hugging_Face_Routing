...
A lightweight, deterministic text‑routing system built using Hugging Face zero‑shot classification. This project demonstrates how a small pre‑qualification model (SLM) can be used for the orchestration layer in a multi-agent workflow.
